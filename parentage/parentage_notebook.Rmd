...
2013: I had 69% assignment rate (153/223), similar to Nick's (67% 151/223).  
...
2014: I had 58% assignment rate (118/203), similar to Nick's (62% 123/197).  
...
```{r}
kable(data.frame( "Offspring Year" = c(2010, 2011, 2012, 2013, 2014, 2015), "Dayan" =  c(6,39,65,69, 58, 73), "Sard" = c(6,38,64, 67, 62, 72)), caption = "Assignment rates of non-carcass samples for the 6 years where both Dayan and Sard infer pedigrees. Assignment rate is the % of offspring assigned to at least one parent") %>%
