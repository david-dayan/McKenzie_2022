...
kable(duplicates %>%
  ...
  kable_classic(full_width = F, html_font = "Cambria")
```
__Table above has an error, these are the total number of duplicates, not the total removed__
